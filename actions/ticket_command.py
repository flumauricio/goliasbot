...
# Wrapper para CreateCategoryModal usando CreateChannelModal
def CreateCategoryModal(guild: discord.Guild, on_success=None):
    """Cria um modal para criar categorias usando CreateChannelModal."""
    return CreateChannelModal(
        guild=guild,
        title="Criar Nova Categoria",
        channel_name_label="Nome da Categoria",
